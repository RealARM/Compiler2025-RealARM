    ...
    public String toString() {
        ...
        switch (conversionType) {
            ...
            case UCVTF:
                ...
                // 假设目标是双精度浮点
                if (dstReg instanceof Backend.Value.Operand.Register.Armv8FPUReg) {
                    dstRegStr = ((Backend.Value.Operand.Register.Armv8FPUReg) dstReg).getDoubleName();
                } else {
            ...
            case FCVTZU:
                ...
                if (srcReg instanceof Backend.Value.Operand.Register.Armv8FPUReg) {
                    srcRegStr = ((Backend.Value.Operand.Register.Armv8FPUReg) srcReg).getDoubleName();
                } else {
                    srcRegStr = srcReg.toString();
                }
                dstRegStr = dstReg.toString();
            ...
            case FCVT_S2D:
                // 单精度到双精度转换：fcvt d, s
                if (srcReg instanceof Backend.Value.Operand.Register.Armv8FPUReg && 
                    dstReg instanceof Backend.Value.Operand.Register.Armv8FPUReg) {
                    Backend.Value.Operand.Register.Armv8FPUReg srcFPU = (Backend.Value.Operand.Register.Armv8FPUReg) srcReg;
                    Backend.Value.Operand.Register.Armv8FPUReg dstFPU = (Backend.Value.Operand.Register.Armv8FPUReg) dstReg;
